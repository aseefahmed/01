...
@section('content')
    ...
    <div class="row" ng-controller="AllRequisitionController" ng-init="initialize('recieved')" ng-cloak>
                                        ...
                                        <tr ng-if="requisitions.length == 0 || filtered.length == 0">
                                            ...
                                            <tr dir-paginate="requisition in filtered = (requisitions| orderBy : sortKey : reverse | filter : search_filter  | itemsPerPage : num_of_items) " ng-cloak>
                                                ...
                                                <td  ng-cloak align="center">
                                                    ...
                                                    <a ng-if="requisition.forwarded_to == {{ Auth::user()->id }}" class="btn btn-danger" ng-click="remove_requisition(requisition.id, requisition.requisition_name, 'single_delete')" requisition_name="## requisition.name ##" requisition_id="## requisition.id ##"><i class="glyphicon glyphicon-trash"></i></a>
                                                </td>
                                            </tr>
