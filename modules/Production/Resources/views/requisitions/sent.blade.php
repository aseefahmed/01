                                ...
                                <div class="col-sm-12">
                                    ...
                                    <table class="table table-responsive table-bordered table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <th class="th-pointer" ng-click="sort('first_name')">Requested To <span class="glyphicon glyphicon-sort-icon"  ng-show="sortKey=='first_name'" ng-class="{'glyphicon-chevron-up':reverse,'glyphicon-chevron-down':!reverse}"></span></th>
