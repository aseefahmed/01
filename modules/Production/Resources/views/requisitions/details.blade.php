                                ...
                                <div class="col-sm-12">
                                    <table class="table table-responsive table-bordered table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-right th-pointer" ng-if="requisitions[0].forwarded_to == {{Auth::user()->id}}" ng-hide="approved == 1" ng-click="sort('items_val')">Approved<span class="glyphicon glyphicon-sort-icon"  ng-show="sortKey=='items_val'" ng-class="{'glyphicon-chevron-up':reverse,'glyphicon-chevron-down':!reverse}"></span></th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr dir-paginate="requisition in filtered = (requisitions| orderBy : sortKey : reverse | filter : search_filter  | itemsPerPage : num_of_items) " ng-cloak>
                                                ...
                                                <td ng-cloak class="text-right col-sm-2 " ng-if="requisitions[0].forwarded_to == {{Auth::user()->id}}"  ng-hide="approved == 1" ><input type="text" class="form-control" ng-model="approved_amount" ng-blur="add_amount(approved_amount)"></td>
                                        ...
                                        <tr>
                                            ...
                                            <th ng-if="requisitions[0].forwarded_to == {{Auth::user()->id}}"  ng-hide="approved == 1" class="text-right">## total_approved_amount ##</th>
                                    ...
                                    <div class="formSep" ng-if="requisitions[0].forwarded_to == {{Auth::user()->id}}">
                                        <button class="btn btn-danger" ng-class="">Clear</button>
                                        <button class="btn btn-success" ng-disabled="total_approved_amount == 0" ng-click="approve_requisition(requisitions[0].requisition_id, total_approved_amount)" ng-hide="hide_approve_btn == 1 || requisitions[0].approved_amount > 0">Approved</button>
                                    </div>
                                </div>
                            </div>
                        </div>
